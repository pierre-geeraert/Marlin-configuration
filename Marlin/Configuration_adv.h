 ...
 */
  ...
  #define THERMAL_PROTECTION_PERIOD 100        // 60 Seconds
  #define THERMAL_PROTECTION_HYSTERESIS 15    // 10 Degrees Celsius
   ...
   * below 2.
   */
  #define WATCH_TEMP_PERIOD 25                //20 Seconds
  #define WATCH_TEMP_INCREASE 6               //2 Degrees Celsius
#endif
 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_PERIOD        100 // 60Seconds
  #define THERMAL_PROTECTION_BED_HYSTERESIS     15 // 5 Degrees Celsius
